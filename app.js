...
// mongodb+srv://abhijeet45:<password>@cluster0.pgyop.mongodb.net/userDB
...
passport.use(new FacebookStrategy({
    clientID: process.env.CLIENT_IDFB,
    clientSecret: process.env.CLIENT_SECRETFB,
